...
export default class BulkExportResources {
  ...
  constructor(
    ...
    multiTenancyEnabled: CfnCondition
  ) {
    ...
    const maxConcurrentRuns = Fn.conditionIf(multiTenancyEnabled.logicalId, 30, 2);
    ...
    this.exportGlueJob = new CfnJob(scope, 'exportGlueJob', {
      ...
      executionProperty: { maxConcurrentRuns: maxConcurrentRuns as unknown as number },
      defaultArguments: {
