...
describe("buildInitiateExportRequest", () => {
  ...
  test("System Export request with query parameters", () => {
    ...
    const actualInitiateExportRequest =
...
describe("getExportUrl", () => {
  describe("All params", () => {
    ...
    const groupId = "12";
    test("System", () => {
      const result = ExportRouteHelper.getExportUrl(
        baseUrl,
        "system",
        queryParams,
        groupId
  ...
  describe("Subset params: only type", () => {
    ...
    test("Patient", () => {
      ...
      expect(result).toEqual(
        "http://api_url.com/Patient/$export?_type=Patient"
      );
    });
    test("Group", () => {
      const result = ExportRouteHelper.getExportUrl(
      ...
      expect(result).toEqual(
        "http://api_url.com/Group/12/$export?_type=Patient"
      );
    });
  });
