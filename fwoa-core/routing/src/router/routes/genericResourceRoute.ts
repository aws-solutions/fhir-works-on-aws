...
export default class GenericResourceRoute {
  ...
  private init() {
    ...
    if (this.operations.includes("read")) {
      ...
      this.router.get(
        "/:id",
        RouteHelper.wrapAsync(
          async (req: express.Request, res: express.Response) => {
            // Get the ResourceType looks like '/Patient'
            const { id, resourceType } = req.params;
            const response = await this.handler.read(
              resourceType,
              id,
              res.locals.tenantId
            );
            const updatedReadResponse =
              await this.authService.authorizeAndFilterReadResponse({
                operation: "read",
      ...
      this.router.get(
        ...
        RouteHelper.wrapAsync(
          async (req: express.Request, res: express.Response) => {
            ...
            const response = await this.handler.vRead(
              resourceType,
              id,
              vid,
              res.locals.tenantId
      ...
      this.router.get(
        ...
        RouteHelper.wrapAsync(
          async (req: express.Request, res: express.Response) => {
            ...
            const { resourceType } = req.params;
            const searchParamQuery = req.query;
            const updatedSearchResponse = await handleSearch(
              res,
              resourceType,
              searchParamQuery
            );
        ...
        RouteHelper.wrapAsync(
          async (req: express.Request, res: express.Response) => {
            ...
            if (response && response.meta) {
              res.set({
                ETag: `W/"${response.meta.versionId}"`,
                "Last-Modified": response.meta.lastUpdated,
              });
            }
      ...
      this.router.put(
        ...
        RouteHelper.wrapAsync(
          async (req: express.Request, res: express.Response) => {
            ...
            const response = await this.handler.update(
              resourceType,
              id,
              body,
              res.locals.tenantId
      ...
      this.router.patch(
        ...
        RouteHelper.wrapAsync(
          async (req: express.Request, res: express.Response) => {
            ...
            const response = await this.handler.patch(
              resourceType,
              id,
              body,
              res.locals.tenantId
      ...
      this.router.delete(
        ...
        RouteHelper.wrapAsync(
          async (req: express.Request, res: express.Response) => {
            // Get the ResourceType looks like '/Patient'
            const { id, resourceType } = req.params;
            const readResponse = await this.handler.read(
              resourceType,
              id,
              res.locals.tenantId
            );
            ...
            const response = await this.handler.delete(
              resourceType,
              id,
              res.locals.tenantId
            );
