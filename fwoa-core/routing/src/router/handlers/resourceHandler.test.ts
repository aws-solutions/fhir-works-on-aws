...
describe("SUCCESS CASES: Testing create, read, update, delete of resources", () => {
  ...
  test("create: patient", async () => {
    ...
    // OPERATE
    const createResponse = await resourceHandler.create(
      "Patient",
      validPatient
    );
  ...
  test("update: patient", async () => {
    ...
    // OPERATE
    const updateResponse = await resourceHandler.update(
      "Patient",
      id,
      validPatient
    );
  ...
  test("patch: patient", async () => {
    ...
    // OPERATE
    const patchResponse = await resourceHandler.patch(
      "Patient",
      id,
      validPatient
    );
  ...
  test("delete: patient", async () => {
    ...
    expect(deleteResponse).toEqual(
      OperationsGenerator.generateSuccessfulDeleteOperation(1)
    );
  });
});
...
describe("Testing search", () => {
  const initializeResourceHandler = (
    searchServiceResponse?: SearchResponse
  ) => {
    ElasticSearchService.typeSearch = jest
      .fn()
      .mockReturnValue(Promise.resolve(searchServiceResponse));
  ...
  test("Search for a patient that exist", async () => {
    ...
    // CHECK
    expect(
      stubs.passThroughAuthz.getAllowedResourceTypesForOperation
    ...
    expect(ElasticSearchService.typeSearch).toHaveBeenCalledWith({
      ...
      searchFilters: [],
      sessionId:
        "44136fa355b3678a1146ad16f7e8649e94fb4fc21fe77e8310c060f61caaff8a", // hash of user identity
    });
  ...
  describe("Pagination", () => {
    test("Pagination with a next page link", async () => {
      ...
      const resourceHandler = initializeResourceHandler({
        result: {
          nextResultUrl:
            "https://API_URL.com/Patient?name=Henry&_getpagesoffset=1&_count=1",
          numberOfResults: 2,
          message: "",
          entries: [
            {
    ...
    test("Pagination with a previous page link", async () => {
      ...
      const resourceHandler = initializeResourceHandler({
        result: {
          previousResultUrl:
            "https://API_URL.com/Patient?name=Henry&_getpagesoffset=0&_count=1",
          numberOfResults: 2,
          message: "",
          entries: [
            {
    ...
    test("Pagination with a previous page link and a next page link", async () => {
      ...
      const resourceHandler = initializeResourceHandler({
        result: {
          nextResultUrl:
            "https://API_URL.com/Patient?name=Henry&_getpagesoffset=2&_count=1",
          previousResultUrl:
            "https://API_URL.com/Patient?name=Henry&_getpagesoffset=0&_count=1",
          numberOfResults: 3,
          message: "",
...
describe("Testing history", () => {
  const initializeResourceHandler = (
    ...
    stubs.history.typeHistory = jest
      .fn()
      .mockReturnValue(Promise.resolve(searchServiceResponse));
    stubs.history.instanceHistory = jest
      .fn()
      .mockReturnValue(Promise.resolve(searchServiceResponse));
  ...
  describe("Pagination", () => {
    test("Pagination with a next page link", async () => {
      ...
      const resourceHandler = initializeResourceHandler({
        result: {
          nextResultUrl:
            "https://API_URL.com/Patient/_history?name=Henry&_getpagesoffset=1&_count=1",
          numberOfResults: 2,
          message: "",
          entries: [
            {
    ...
    test("Pagination with a previous page link", async () => {
      ...
      const resourceHandler = initializeResourceHandler({
        result: {
          previousResultUrl:
            "https://API_URL.com/Patient/_history?name=Henry&_getpagesoffset=0&_count=1",
          numberOfResults: 2,
          message: "",
          entries: [
            {
    ...
    test("Pagination with a previous page link and a next page link", async () => {
      ...
      const resourceHandler = initializeResourceHandler({
        result: {
          nextResultUrl:
            "https://API_URL.com/Patient/_history?name=Henry&_getpagesoffset=2&_count=1",
          previousResultUrl:
            "https://API_URL.com/Patient/_history?name=Henry&_getpagesoffset=0&_count=1",
          numberOfResults: 3,
          message: "",
