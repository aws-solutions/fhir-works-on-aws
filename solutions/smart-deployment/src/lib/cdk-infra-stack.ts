...
export default class FhirWorksStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: FhirWorksStackProps) {
    ...
    const lambdaDefaultEnvVars = {
      ...
      CUSTOM_USER_AGENT: 'AwsSolution/SO0128/GH-v6.1.1-smart',
    ...
    const updateSearchMappingsLambdaFunctionDLQ = new Queue(this, 'updateSearchMappingsLambdaFunctionDLQ', {
      retentionPeriod: Duration.days(14),
      encryptionMasterKey: Alias.fromAliasName(
        this,
        'updateSearchMappingsLambdaFunctionDLQKey',
        'alias/aws/sqs'
      )
    });
    ...
    const subscriptionReaperDLQHttpsOnlyPolicy = new QueuePolicy(
      this,
      'subscriptionReaperDLQHttpsOnlyPolicy',
      {
